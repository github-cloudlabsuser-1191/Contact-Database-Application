...
namespace CRUD_application_2.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Details(int id)
        {
            ...
            // If successful, it returns the Details view with the user information.
            // If an error occurs during the process, it returns the Index view.
            return View();
        ...
        public ActionResult Edit(int id)
        {
            ...
            // If no user is found with the provided ID, it returns a HttpNotFoundResult.
            // If successful, it returns the Edit view with the user information.
            // If an error occurs during the process, it returns the Index view.
            return View();
        }
        ...
        public ActionResult Delete(int id)
        {
            ...
            // If no user is found with the provided ID, it returns a HttpNotFoundResult.
            // If successful, it returns the Delete view with the user information.
            // If an error occurs during the process, it returns the Index view.
            return View();
        ...
        public ActionResult Delete(int id, FormCollection collection)
        {
            ...
            // If successful, it redirects to the Index action to display the updated list of users.
            // If no user is found with the provided ID, it returns a HttpNotFoundResult.
            // If an error occurs during the process, it returns the Delete view.
